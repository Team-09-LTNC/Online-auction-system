...
public class StatusCode {
    ...
    public static final int FORBIDDEN    = 403; // Đã đăng nhập nhưng không có quyền (VD: Sai Role)
    public static final int NOT_FOUND    = 404; // Không tìm thấy dữ liệu (VD: Sản phẩm đã bị xóa)

    // --- Lỗi do hệ thống (Server) ---
    public static final int SERVER_ERROR = 500; // Lỗi code trên server hoặc lỗi Database
