 ...
 * Giúp client dễ dàng dùng switch-case để hiển thị thông báo lỗi phù hợp lên giao diện.
 */
...
public class ErrorCode {
    ...
    // --- LỖI HỆ THỐNG ---
    public static final String INTERNAL_SERVER_ERROR = "ERR_SERVER_FAULT";    // Lỗi chung (mất kết nối database, NullPointer...)
}
