...
/**
 * DTO (đối tượng truyền dữ liệu) dùng để gửi dữ liệu vẽ biểu đồ về client.
 */
public class BidLine implements Serializable {
    private String bidderName; // Tên người đặt giá
    ...
    // Phương thức lấy/gán giá trị (dùng cho GSON)
