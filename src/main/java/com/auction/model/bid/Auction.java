...
public class Auction extends Entity {
    ...
    // synchronized: khóa lại không cho nhiều người đặt giá và cùng xử lý chúng một lúc
    ...
    // synchronized: Đảm bảo không ai đặt giá được ngay lúc luồng timer đang đóng cửa phiên
